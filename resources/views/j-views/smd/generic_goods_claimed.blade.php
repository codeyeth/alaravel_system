<table style="border-collapse:collapse;">
  ...
  <th width="35%" style="font-size:6px; text-align:left;">
      ...
      <th width="60%" style="text-align:left; font-size:9px">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label style="font-size:6px;"><b>REPORTS OF CLAIMED GOODS IN-HOUSE - GENERIC</b></label><br>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label style="font-size:7px;"><b>For the period {{ \Carbon\Carbon::parse($generic_claimed_from)->format('F, j') }}-{{ \Carbon\Carbon::parse($generic_claimed_to)->format('j Y') }}</b></label><br>
        </th>
    </tr>
</table>
<table>
