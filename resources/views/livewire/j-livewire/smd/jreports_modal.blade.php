            ...
            <div class="modal-body">
                ...
                <div class="tab-content" id="myTab">
                        ...
                        <div class="tab-content" id="myTab">
                            <div class="tab-pane fade show" id="generic" role="tabpanel" aria-labelledby="generic-tab" wire:ignore.self>
                                <div class="form-group">
                                    {{Form::open(['route' => 'generic', 'method' => 'GET', 'autocomplete'=>'off', 'target' => '_blank'])}} <br>
                                    <label for="feRequestAtt">Date:</label>
                                    <input type="date" name="input_daily_generic" id="id_daily_generic" class="input-sm form-control" >
                                </div><br>
                            ...
                            <div class="tab-pane fade" id="specialized" role="tabpanel" aria-labelledby="specialized-tab" wire:ignore.self>
                                <div class="form-group">
                                    {{Form::open(['route' => 'specialized', 'method' => 'GET', 'autocomplete'=>'off', 'target' => '_blank'])}} <br>
                                    <label for="feRequestAtt">Date:</label>
                                    <input type="date" name="input_daily_specialized" id="id_daily_specialized" class="input-sm form-control" >
                                </div><br>
                                <button type="button"  class="btn btn-secondary" data-dismiss="modal">Close</button>
                                {{ Form::button('Print',['type' => 'submit','class'=>'btn btn-primary']) }}
                                {{ Form::close() }}
                    ...
                    <div class="tab-pane fade" id="monthly" role="tabpanel" aria-labelledby="monthly-tab" wire:ignore.self>
                        <div class="form-group">
                            {{Form::open(['route' => 'monthly', 'method' => 'GET', 'autocomplete'=>'off', 'target' => '_blank'])}} <br>
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <strong class="text-muted d-block mb-2">Reports datetime from:</strong>
                                    <input type="date" name="input_monthly_si_datefrom" id="id_monthly_si_datefrom" class="input-sm form-control"  >
                                </div>
                                <div class="form-group col-md-6">
                                    <strong class="text-muted d-block mb-2">Reports datetime to:</strong>
                                    <input type="date" name="input_monthly_si_dateto" id="id_monthly_si_dateto"     class="input-sm form-control"  >
                                </div>
                            </div>
                        </div><br>
                            <button type="button"  class="btn btn-secondary" data-dismiss="modal">Close</button>
                    ...
                    <div class="tab-pane fade" id="claimed" role="tabpanel" aria-labelledby="claimed-tab" wire:ignore.self>
                        ...
                        <div class="tab-content" id="myTab">
                            <div class="tab-pane fade show" id="genericclaimed" role="tabpanel" aria-labelledby="genericclaiemd-tab" wire:ignore.self>
                                <div class="form-group">
                                    {{Form::open(['route' => 'genericclaimed', 'method' => 'GET', 'autocomplete'=>'off', 'target' => '_blank'])}} <br>
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <strong class="text-muted d-block mb-2">Reports datetime from:</strong>
                                            <input type="date" name="input_generic_claimed_datefrom" id="id_generic_claimed_datefrom" class="input-sm form-control"  >
                                        </div>
                                        <div class="form-group col-md-6">
                                            <strong class="text-muted d-block mb-2">Reports datetime to:</strong>
                                            <input type="date" name="input_generic_claimed_dateto" id="id_generic_claimed_dateto"     class="input-sm form-control"  >
                                        </div>
                                    </div>
                                </div><br>
                                    <button type="button"  class="btn btn-secondary" data-dismiss="modal">Close</button>
                            ...
                            <div class="tab-pane fade show" id="specializedclaimed" role="tabpanel" aria-labelledby="specializedclaiemd-tab" wire:ignore.self>
                                <div class="form-group">
                                    {{Form::open(['route' => 'specializedclaimed', 'method' => 'GET', 'autocomplete'=>'off', 'target' => '_blank'])}} <br>
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <strong class="text-muted d-block mb-2">Reports datetime from:</strong>
                                            <input type="date" name="input_specialized_claimed_datefrom" id="id_specialized_claimed_datefrom" class="input-sm form-control" >
                                        </div>
                                        <div class="form-group col-md-6">
                                            <strong class="text-muted d-block mb-2">Reports datetime to:</strong>
                                            <input type="date" name="input_specialized_claimed_dateto" id="id_specialized_claimed_dateto"     class="input-sm form-control"  >
                                        </div>
                                    </div>
                                </div><br>
                                <button type="button"  class="btn btn-secondary" data-dismiss="modal">Close</button>
                    ...
                    <div class="tab-pane fade" id="unclaimed" role="tabpanel" aria-labelledby="unclaimed-tab" wire:ignore.self>
                        ...
                        <div class="tab-content" id="myTab">
                            <div class="tab-pane fade show" id="genericunclaimed" role="tabpanel" aria-labelledby="genericunclaiemd-tab" wire:ignore.self>
                                 <div class="form-group">
                                    {{Form::open(['route' => 'genericunclaimed', 'method' => 'GET', 'autocomplete'=>'off', 'target' => '_blank'])}} <br>
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <strong class="text-muted d-block mb-2">Reports datetime from:</strong>
                                            <input type="date" name="input_generic_unclaimed_datefrom" id="id_generic_unclaimed_datefrom" class="input-sm form-control" placeholder="Date From" >
                                        </div>
                                        <div class="form-group col-md-6">
                                            <strong class="text-muted d-block mb-2">Reports datetime to:</strong>
                                            <input type="date" name="input_generic_unclaimed_dateto" id="id_generic_unclaimed_dateto"     class="input-sm form-control" placeholder="Date To" >
                                        </div>
                                    </div>
                                </div><br>
                                <button type="button"  class="btn btn-secondary" data-dismiss="modal">Close</button>
                            ...
                            <div class="tab-pane fade show" id="specializedunclaimed" role="tabpanel" aria-labelledby="specializedunclaiemd-tab" wire:ignore.self>
                                <div class="form-group">
                                    {{Form::open(['route' => 'specializedunclaimed', 'method' => 'GET', 'autocomplete'=>'off', 'target' => '_blank'])}} <br>
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <strong class="text-muted d-block mb-2">Reports datetime from:</strong>
                                            <input type="date" name="input_specialized_unclaimed_datefrom" id="id_specialized_unclaimed_datefrom" class="input-sm form-control" placeholder="Date From" >
                                        </div>
                                        <div class="form-group col-md-6">
                                            <strong class="text-muted d-block mb-2">Reports datetime to:</strong>
                                            <input type="date" name="input_specialized_unclaimed_dateto" id="id_specialized_unclaimed_dateto"     class="input-sm form-control" placeholder="Date To" >
                                        </div>
                                    </div>
                                </div><br>
                                <button type="button"  class="btn btn-secondary" data-dismiss="modal">Close</button>
