                ...
                <div class="modal-body">
                    ...
                    <div class="tab-content" id="myTab">
                        ...
                        <div class="tab-pane fade" id="monthly" role="tabpanel" aria-labelledby="monthly-tab" wire:ignore.self>
                            <div class="form-group">
                                {{Form::open(['route' => 'monthly', 'method' => 'GET', 'autocomplete'=>'off'])}} <br>
                                    <div class="form-row">
                        ...
                        <div class="tab-pane fade" id="unclaimed" role="tabpanel" aria-labelledby="unclaimed-tab" wire:ignore.self>
                            ...
                            <div class="tab-content" id="myTab">
                                <div class="tab-pane fade show" id="genericunclaimed" role="tabpanel" aria-labelledby="genericunclaimed-tab" wire:ignore.self>
                                    <div class="form-group">
                                ...
                                <div class="tab-pane fade" id="specializedunclaimed" role="tabpanel" aria-labelledby="specializedunclaimed-tab" wire:ignore.self>
                                    <div class="form-group">
                        ...
                        <div class="tab-content" id="myTab">
                                ...
                                <div class="tab-pane fade" id="specializedclaimed" role="tabpanel" aria-labelledby="specializedclaimed-tab" wire:ignore.self>
                                    <div class="form-group">
