        ...
        <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="wastageTitle">Wastage Management</h5>
                ...
                <div class="modal-body">
                    ...
                    <input type="text" class="form-control" placeholder="Ballot ID" wire:model="wastageBallotId" required>
                    <br>
